...
namespace Knockout.Tests {
	...
	public class AttributeTests {
		private static KnockoutPropertyAttribute _unusedAttr = new KnockoutPropertyAttribute();	// Force a reference to that assembly
...
public class C1 {
	...
	public static int P1 { get; set; }
		...
		[Test]
		public void ExplicitlyImplementedKnockoutPropertyIsAnError1() {
			Prepare(
@"using KnockoutApi;
[KnockoutModel]
public class C1 {
	public int P1 { get { return 0; } set {} }
			...
			Assert.That(_errorReporter.AllMessages.Any(m => m.FormattedMessage.Contains("not an auto-property") && m.FormattedMessage.Contains("C1.P1")));
...
public class C1 {
	public int P1 { set {} }
		...
		[Test]
		public void ExplicitlyImplementedKnockoutPropertyIsAnError2() {
			Prepare(
@"using KnockoutApi;
public class C1 {
	[KnockoutProperty]
